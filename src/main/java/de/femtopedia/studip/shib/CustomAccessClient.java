...
public abstract class CustomAccessClient {
    ...
    /**
     * The default encoding for the {@link InputStream}s.
     */
     ...
     */
    private OkHttp3CookieHelper cookieHelper;
    ...
    /**
     * Helper method for reading lines as {@link String}s from an
     * {@link InputStream} using UTF-8.
     *
     ...
     * @throws OAuthException           if any OAuth errors occur.
     */
    public abstract CustomAccessHttpResponse get(String url,
                                                 String[] headerKeys,
                                                 String[] headerVals)
            throws IOException, IllegalArgumentException,
            IllegalAccessException, OAuthException;
     ...
     * @throws OAuthException           if any OAuth errors occur.
     */
    public abstract CustomAccessHttpResponse post(
            String url,
            String[] headerKeys,
            String[] headerVals,
            List<Pair<String, String>> nvps)
     ...
     * @throws OAuthException           if any OAuth errors occur.
     */
    public abstract CustomAccessHttpResponse put(
            String url,
            String[] headerKeys,
            String[] headerVals,
            List<Pair<String, String>> nvps)
     ...
     * @throws OAuthException           if any OAuth errors occur.
     */
    public abstract CustomAccessHttpResponse delete(
            String url,
            String[] headerKeys,
            String[] headerVals,
            List<Pair<String, String>> nvps)
     ...
     * @param headerKeys     An array containing keys for the headers to send
     *                       with the request.
     * @param headerVals     An array containing values for the headers to send
     *                       with the request (size must be the same as
     *                       headerKeys.length).
     * @return A {@link CustomAccessHttpResponse} representing the result.
     * @throws IOException              if reading errors occur.
     * @throws IllegalArgumentException if the header values are broken.
     * @throws IllegalAccessException   if the session isn't valid.
     */
    protected CustomAccessHttpResponse executeRequest(
            Request.Builder requestBuilder, String[] headerKeys,
            String[] headerVals)
            throws IOException, IllegalArgumentException,
