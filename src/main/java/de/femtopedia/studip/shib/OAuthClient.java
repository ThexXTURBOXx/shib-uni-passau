...
public class OAuthClient extends CustomAccessClient {
	...
	public void setupOAuth(String consumerKey, String consumerSecret) {
		...
		provider.setOkHttpClient(client);
	}
	 ...
	 * @throws OAuthException           if any OAuth errors occur
	 */
	public CustomAccessHttpResponse post(String url, String[] headerKeys, String[] headerVals, List<Pair<String, String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException, OAuthException {
		Request.Builder requestBuilder = new Request.Builder()
				.url(url);
	 ...
	 * @throws OAuthException           if any OAuth errors occur
	 */
	public CustomAccessHttpResponse put(String url, String[] headerKeys, String[] headerVals, List<Pair<String, String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException, OAuthException {
		Request.Builder requestBuilder = new Request.Builder()
				.url(url);
	...
	public CustomAccessHttpResponse delete(String url, String[] headerKeys, String[] headerVals, List<Pair<String, String>> nvps) throws IOException, IllegalArgumentException, IllegalAccessException, OAuthException {
		Request.Builder requestBuilder = new Request.Builder()
				.url(url);
		Request request = sign(requestBuilder.delete(getFormBody(nvps)).build());
		return executeRequest(
				request.newBuilder(),
				headerKeys, headerVals);
	}
